...
const DINNERS = [
  ...
  {
    id: "parmesan-cream",
    name: "Chicken in parmesan and anchovy cream",
    subtitle: "Boneless thighs braised in a rich, salty cream sauce. Thirty minutes, one pan.",
    protein: "Chicken",
    totalMins: 30,
    effort: "Medium",
    needsAhead: { label: "Thaw the thighs — about an hour in cold water, or overnight in the fridge", mins: 60 },
    ...
    ingredients: [
      ...
      { id: "onion", name: "frozen diced onions", qty: 100, unit: "g" },
      { id: "garlic", name: "frozen chopped garlic", qty: 2, unit: "tsp" },
      { id: "anch", name: "anchovy fillets", qty: 2, unit: "" },
      { id: "cream", name: "double cream", qty: 150, unit: "ml" },
      { id: "water", name: "water", qty: 50, unit: "ml" },
      { id: "parm", name: "parmesan, finely grated", qty: 30, unit: "g" },
      { id: "vin", name: "rice vinegar", qty: 1, unit: "tsp" },
      ...GREENS,
    ],
    steps: [
      { at: 0, title: "Brown the thighs", body: "Pat {thigh} dry. {oil} in the pan, medium-high. 4 minutes undisturbed until browned, then turn for 2 minutes. Out onto a plate — they won't be cooked through yet, and shouldn't be.", timer: 6 },
      { at: 6, title: "Onions", body: "{onion} into the same pan, 5 minutes until soft and the water's gone.", timer: 5 },
      { at: 11, title: "Garlic and anchovies", warn: true, body: "{garlic}, 30 seconds. {anch} in, mashed against the pan with a wooden spoon for a minute until they disappear completely. They have to melt into the fat before any liquid goes in, or they stay as recognisable fish.", timer: 2 },
      { at: 13, title: "Cream and water", body: "{cream} and {water} in. Simmer gently — don't let it boil hard." },
      { at: 14, title: "Braise", body: "Thighs back in with any juices from the plate. Lid on, low, 12 minutes. {ts} and {pc} in alongside for the last 6.", timer: 12 },
      { at: 26, title: "Check", body: "Thighs out. 75°C at the thickest part, then the pan off the heat." },
      { at: 27, title: "Parmesan", warn: true, body: "{parm} in off the heat, stirred until melted. Never boil after the cheese goes in — it splits into grainy threads and oily liquid, and won't come back together." },
      { at: 29, title: "Season", body: "{vin} and plenty of black pepper. Taste — no salt needed, the anchovies and parmesan have already done it." },
      { at: 30, title: "Plate", body: "Slice the thighs thickly and put them back into the sauce." },
    ],
  },
  {
